...
public class MyLog1 extends Thread{
    ...
    public String tag1;
    public String msg1;
    public MyLog1(String tag1, String msg1){
        this.tag1=tag1;
        this.msg1=msg1;
    }
public void run(){
    ...
    private static void writeLogtoFile(String mylogtype, String tag, String text) {// 新建或打开日志文件
        ...
        File dirsFile = new File(dirPath.getAbsolutePath()+"/BluTest");
        Log.v("posti",dirsFile.toString());
        if (!dirsFile.exists()){
            dirsFile.mkdirs();
        }
        //Log.i("创建文件","创建文件");
